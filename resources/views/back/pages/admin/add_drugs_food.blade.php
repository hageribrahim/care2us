                ...
                <div class="col-md-12">
                    <div class="panel panel-flat">
                        ...
                        <div class="container-fluid">
                            <div class="content">
                              <form method="post" action="{{url('/store-drug-food')}}" >
                                  {{ csrf_field() }}
                                    <div class=" col-md-6 ">
                                            ...
                                            <div class="multi-fields">
                                              <div class="multi-field ">
                                                <div class="col-lg-4">
                                                  ...
                                                  <input type="text" name="foods[]" class="form-control form-app"  value="{{ old('food') }}" placeholder=" الطعام " >

                                                @if($errors->has('foods.*'))
                                                      <span class="help-block">
                                                        <small class="text-danger">{{$errors->first('foods.*')}}</small>
                                                      </span>
                                                  @endif
