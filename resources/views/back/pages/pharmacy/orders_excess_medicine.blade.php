                            ...
                            <div class="content">
                                ...
                                <div class="panel panel-flat">
                                    <table class="table datatable-basic">
                                        ...
                                        <tbody>
                                        <?php $i = 0; ?>
                                        @foreach($request_medicines as $request)
                                            <tr>
                                                <td>{{ ++$i }}</td>
                                                ...
                                                <td>
                                                  ...
                                                  <a href="{{url('/accept-request-surplus/'.$request->id)}}" class="btn bg-success"><i class="icon-checkmark3"></i> موافق</a>
                                                  <a href="{{url('/reject-request-surplus/'.$request->id)}}" class="btn bg-danger"><i class="icon-cross3"></i>  غير موافق </a>
                                                  @elseif($request->status=="accept")
                                                      <div class="btn btn-success">  {{$request->status}} </div>
                                                  @else
                                                      <div class="btn btn-danger">  {{$request->status}} </div>
                                                  @endif
                                                </td>
