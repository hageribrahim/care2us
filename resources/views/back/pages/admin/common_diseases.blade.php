                        ...
                        <div class="panel-heading">
                            <a href="{{url('/add-common-dieases')}}">
                                <span class="pull-right">
                                    <p class="btn btn-info btn-xs"><i class="icon-plus-circle2"></i> اضف مرض شائع </p>
                                </span>
                            </a>
                            <h6 class="panel-title"><i class="icon-backspace"> </i> الامراض الشائعة</h6>
                            <hr>
                        </div>
                                    ...
                                    <table class="table datatable-button-html5-basic">
                                        ...
                                        @foreach($subjects as $subject)
                                            <tr>
                                                ...
                                                <td>{{$subject->name}}</td>
                                                <td>{{$subject->title}}</td>
                                                <td><a href="{{url('/details-subject/'.$subject->id)}}"><i
                                                                class="icon-eye2"> </i> التفاصيل </a></td>
                                                <td><a href="{{url('/update-subject/'.$subject->id)}}"><i
                                                                class="icon-pencil5"> </i> تعديل </a></td>
                                                <td><a href="{{url('/delete-subject/'.$subject->id)}}"
