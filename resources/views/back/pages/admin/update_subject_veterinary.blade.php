                ...
                <div class="col-md-12">
                    <div class="panel panel-flat">
                        ...
                        <div class="container-fluid">
                            <div class="content">
                                <form method="post" action="{{url('/edit-subject-veterinary/'.$subject->id)}}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class=" col-md-6 ">

                                        <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                            <label for="title">الموضوع *</label>
                                            <input type="text" id="title" name="title" @if(isset($subject)) value="{{ $subject->title}}" @else value="{{ old('title') }}"  @endif  class="form-control form-app">
                                            @if ($errors->has('title'))
                                        ...
                                        <div class="form-group {{ $errors->has('category') ? ' has-error' : '' }}">
                                            ...
                                            <select name="category" class="form-control">
                                                ...
                                                @foreach($categories as $category)
                                                    ...
                                                    @if(isset($subject) && $subject->category_id == $category->id)
                                        ...
                                        <div class="form-group {{ $errors->has('image') ? ' has-error' : '' }}">
                                            ...
                                            <div class="form-group has-feedback has-feedback-left">
                                                ...
                                                <img id="first"
                                                     @if(isset($subject) &&$subject->image !=null )  src="{{url('images/medicines/'.$subject->image)}}"
