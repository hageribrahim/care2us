                ...
                <div class="col-md-12">
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <a href="{{url('/add-statistics')}}">
                                <span class="pull-right">
                                    <p class="btn btn-info btn-xs"><i class="icon-plus-circle2"></i>  اضف احصائية دواء</p>
                                </span>
                            </a>
                            <h6 class="panel-title"><i class="icon-stats-growth"> </i> الاحصائيات </h6>
                            <hr>
                        </div>
                                        ...
                                        <table class="table datatable-basic">
                                            ...
                                            @foreach($medicines as $medicine)
                                                <tr>
                                                    ...
                                                    <td><a href="{{url('/compare-statistics/'.$medicine->id)}}"><i class="icon-align-bottom"></i> تعديل </a></td>
                                                    <td><a href="{{url('/edit-statistics/'.$medicine->id)}}"><i class="icon-pencil5"></i> تعديل </a></td>
                                                    <td><a href="{{url('/delete-statistics/'.$medicine->id)}}" onclick="return confirm('هل تريد حذف هذا العرض ؟');"><i class="icon-trash"></i> حذف </a></td>
